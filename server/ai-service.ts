...
function selectAIModel(context: ChatContext): string {
...
function generateSystemPrompt(context: ChatContext, modelName: string): string {
...
async function tryFallbackModel(message: string, context: ChatContext): Promise<string> {
  const fallbackOrder = ['llama-free', 'phi-free'];
