...
// Sample data for farmer's products
const sampleProducts = [
  { id: 1, name: 'Organic Tomatoes', category: 'Vegetables', price: '$3.99', stock: 85, status: 'active', farmer: 'Green Valley Farm', image: 'https://images.unsplash.com/photo-1546470427-e26264be0b0d?w=400&h=300&fit=crop' },
  { id: 2, name: 'Fresh Strawberries', category: 'Fruits', price: '$4.99', stock: 120, status: 'active', farmer: 'Berry Fields', image: 'https://images.unsplash.com/photo-1464965911861-746a04b4bca6?w=400&h=300&fit=crop' },
  { id: 3, name: 'Local Honey', category: 'Dairy', price: '$7.99', stock: 45, status: 'active', farmer: 'Sweet Meadows', image: 'https://images.unsplash.com/photo-1587049352846-4a222e784d38?w=400&h=300&fit=crop' },
  { id: 4, name: 'Free-Range Eggs', category: 'Dairy', price: '$5.49', stock: 72, status: 'active', farmer: 'Happy Hen Farm', image: 'https://images.unsplash.com/photo-1518569656558-1f25e69d93d7?w=400&h=300&fit=crop' },
];
