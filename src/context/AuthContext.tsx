...
interface AuthContextType {
  ...
  signupWithEmail: (userData: EmailSignupData) => Promise<{ success: boolean; needsVerification?: boolean; error?: string }>;
  signupWithPhone: (userData: PhoneSignupData) => Promise<{ success: boolean; needsVerification?: boolean; error?: string }>;
    ...
    try {
      ...
      if (data.user && !data.session) {
        ...
        toast({
          ...
          description: "We've sent you a verification code via SMS. Please enter the code to complete your registration.",
        });
        return { 
          success: true, 
          needsVerification: true 
